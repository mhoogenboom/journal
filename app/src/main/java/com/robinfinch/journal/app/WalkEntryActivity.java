 ...
 */
public class WalkEntryActivity extends BaseActivity implements WalkEntryFragment.Parent {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(LOG_TAG, "Create walk entry activity for " + uri);

        Fragment fragment = WalkEntryFragment.newInstance(uri);
